...
export async function GET(request: Request) {
  try {
    ...
    if (featuredOnly) {
      const featured = await Auction.findOne({
        featured: true,
      }).lean();
          ...
          ? [
              {
                ...
                id: featured.publicId,

                titleEn: featured.title.en,
                titleAm: featured.title.am,

                subtitleEn: featured.subtitle.en,
                subtitleAm: featured.subtitle.am,

                descriptionEn: featured.description.en,
                descriptionAm: featured.description.am,

                title: featured.title[language],
                subtitle:
                  featured.subtitle[language],
                description:
                  featured.description[language],

                status: getAuctionStatus(featured),
